...
place(royal_bedroom, "There are keys to every room on the castle.").
...
are_inner_places(royal_bedroom).
...
all_desc_place(royal_bedroom, ["You are now in the royal bedroom. You see a spacious room full of expensive furniture and numerous paintings.", "<\n>",
